    ...
    var chart = new Chart($("#sentimentGauge"), {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [1, 2, 3],
          backgroundColor: ['rgba(255,99,132,1)', 'rgba(255, 206, 86, 1)', 'rgba(126, 178, 109, 1)'],
        }]
      },
      options: {
        needle: {
    ...
    $.ajax({
        ...
        success: function(result){
            if(result.sentiment == undefined){
                ...
                //do something here e.g. show tips to user: no related tweets!
                console.log("no related tweets")
