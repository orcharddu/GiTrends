...
module.exports = {
    ...
    adminAuth: {
       ...
       users: [{
           username: "gitrends",
           password: "$2a$08$0ItONSywFfa/fHtMEwc0oeqeZfjrIFA7D8.lkU5bBZzVmvjWixhBu",
           permissions: "*"
       }]
    },
    ...
    // https object:
    https: {
        key: require("fs").readFileSync(require("path").join(__dirname, "/cert/privkey.pem")),
        cert: require("fs").readFileSync(require("path").join(__dirname, "/cert/cert.pem"))
    },
    //https function:
    // https: function() {
